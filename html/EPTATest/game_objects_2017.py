...
dimension_names = ["OverWorld", "BSB", "Capstone Room",
                   "Green Lake", "Haunted Forest", "Cabin in the Woods"]
...
def PlayableCharacters(ITEMS):
    ...
    STARTINV = {'head': EMPTYHEAD, 'body': EMPTYBODY,
                'hand': EMPTYHAND, 'off-hand': ITEMS["polaroid photograph"]}
    ...
    # needs to be unique or else get ghosting/aliasing position
    BRENINV = {'head': EMPTYHEAD, 'body': EMPTYBODY,
               'hand': EMPTYHAND, 'off-hand': EMPTYOFFHAND}
    ...
    Tyler = Character('Tyler Kashak', list(
        STARTLOCATION), 420, TYINV, EMPTYINV)
...
def Reset():
    ...
    LOCATIONS1 = [
        ...
        Map("MUSC", (5, 0, 1, 0), "~~:\n", "The "+mapcolour+"Student Centre"+textcolour + \
        ...
        Map("BSB", (3, 4, 1, 0), "~BSB~:\n ", "You were told JHE would be your home but after picking Eng Phys\nyou didn't realize how wrong you were.\nAt least the cafe is better than JHE's.\nA shudder runs through your body as you draw nearer to the electronics labs.\nWiping a " + \
            itemcolour+"cold sweat"+textcolour+" from your brow you plan ahead.", (), True, (3, 3, 0)),
        ...
        Map("Thode", (1, 7, 1, 0), "~~:\nABB is at your rear. The campus exit is to your right.\nCootes Drive is to your left. You can go up or down the stairs.",
        ...
        Map("Forest", (4, 1, 0, 4), "FOREST: (\S)",
            "The brush... it is thicc. (\S)You narrowly avoid stepping in a puddle.", ('l', 'r'), False),
        Map("Forest", (4, 2, 0, 4), "FOREST: (\S)",
            "The crunch of leaves beneath your feet is all you hear besides the wind whistling...", ('l', 'f'), False),
        Map("Forest", (5, 2, 0, 4), "FOREST: (\S)",
            "A chipmunk rushes past you giving your 'fight or flight' reflex a workout...", ('r', 'f'), False),
        Map("Forest", (5, 1, 0, 4), "FOREST: (\S)",
            "A small break in the trees above allows a rush of light to temporarily shine on your face...", ('l'), False),
        Map("Forest", (5, 0, 0, 4), "FOREST: (\S)",
            "You get the feeling you cannot go anywhere but back the way you came...", ('l', 'r', 'b'), False),
        Map("Forest", (6, 1, 0, 4), "FOREST: (\S)",
            "You wonder if it is time to drink your urine... (\S)I heard Bear Grylls did that once.", ('b', 'f'), False),
        Map("Forest", (7, 1, 0, 4), "FOREST: (\S)",
            "You enter a small clearing... (\S)You can go in any of the cardinal directions.", (), False),
        Map("Forest", (7, 0, 0, 4), "FOREST: (\S)",
            "I wonder who actually took the time to map out the Bruce Trail? (\S)Like c'mon...", ('r', 'b'), False),
        Map("Forest", (6, 0, 0, 4), "FOREST: (\S)",
            "You get the feeling you cannot go anywhere but back the way you came...", ('f', 'b', 'l'), False),
        Map("Forest", (8, 1, 0, 4), "FOREST: (\S)",
            "You enter a small clearing... (\S)You can go in any of the cardinal directions except backwards.", ('b'), False),
        Map("Forest", (9, 1, 0, 4), "FOREST: (\S)",
            "Early settlers used to think that pinecones were tree poop... (\S)When they stepped on one they would say: (\S)'Oh no I got tree poop on my tootsies.'", ('r', 'f'), False),
        Map("Forest", (9, 0, 0, 4), "FOREST: (\S)",
            "You feel like you hear muttering in the distance... (\S)Must be the wind.", ('r', 'b'), False),
        Map("Forest", (8, 0, 0, 4), "FOREST: (\S)",
            "You get the feeling you cannot go anywhere but back the way you came...", ('f', 'b', 'l'), False),
        Map("Forest", (8, 2, 0, 4), "FOREST: (\S)",
            "You see a red-tail squirrel... (\S)A common pest in cottage country.", ('f', 'l'), False),
        Map("Forest", (9, 2, 0, 4), "FOREST: (\S)",
            "Does humming while hiking make the trail go by faster? (\S)Better to just enjoy the nature around you...", ('r', 'b'), False),
        Map("Forest", (9, 3, 0, 4), "FOREST: (\S)",
            "A air goes cold and still... (\S)You feel as if you are being watched.", ('f', 'r'), False),
        Map("Forest", (8, 3, 0, 4), "FOREST: (\S)",
            "You wonder how many colours of leaf there could possibly be... (\S)I mean, on the wavelength level... (\S)Nevermind.", ('b', 'l'), False),
        Map("Forest", (8, 4, 0, 4), "FOREST: (\S)",
            "Has any one tree ever been perfectly replicated? In the same forest? (\S)Across the world? Across time? (\S)Hmmm... ", ('l', 'r'), False),
        Map("Forest", (8, 5, 0, 4), "FOREST: (\S)",
            "You stumble over a tree root almost as if it reached out and clipped your leg...You must be seeing things...", ('f', 'r'), False),
        Map("Forest", (7, 5, 0, 4), "FOREST: (\S)",
            "The song 'Trees' by Rush seems to be making a lot of sense right about now...", ('f', 'b'), False),
        ...
        Map("Forest", (4, 3, 0, 4), "FOREST: (\S)",
            "You enter a small clearing... (\S)You can go in any of the cardinal directions except backward.", (
                'b'),
            False),
        Map("Forest", (3, 3, 0, 4), "FOREST: (\S)",
            "'A small scramble up a few rocks never hurt nobody...'(\S)In that very moment you scrape your knee...(\S)Ouch.", ('f', 'b'), False),
        Map("Forest", (2, 3, 0, 4), "FOREST: (\S)",
            "You hear a bustle in the hedgerow... (\S)'Don't get alarmed now.' (\S)You think to yourself...", ('l', 'f'), False),
        ...
        Map("Forest", (2, 0, 0, 4), "FOREST: (\S)",
            "You enter a small clearing... (\S)You can go in any of the cardinal directions except backward.", (
                'b'),
            False),
        Map("Forest", (1, 0, 0, 4), "FOREST: (\S)",
            "You hear giggling through the brush... (\S)'Of course, a child's laugh in the forest... perfectly normal.' (\S)You think to yourself...", ('b', 'f'), False),
        ...
        Map("Forest", (1, 3, 0, 4), "FOREST: (\S)",
            "The brush grows thicker and less light makes it through the trees... (\S)You feel colder too.", (
                'r', 'b'),
            False),
        ...
        Map("Forest", (5, 7, 0, 4), "FOREST: (\S)",
            ...
            ('r', 'b'), False),
        Map("Forest", (5, 8, 0, 4), "FOREST: (\S)",
            "You notice slash marks on the side of a tree... (\S)Are they from an animal? A murderer? (\S)Better not stick around to find out.", ('f', 'l'), False),
        ...
        Map("Forest", (4, 9, 0, 4), "FOREST: (\S)",
            ...
            ('r', 'f'), False),
        Map("Forest", (4, 8, 0, 4), "FOREST: (\S)",
            "All around you you see fallen trees and stumps of trees which have been cut down... (\S)'Deforestation is such a shame' you think to yourself while shaking your fist.", ('r', 'b'), False),
        ...
        Map("Forest", (7, 7, 0, 4), "FOREST: (\S)",
            "The thick brush subsides and you begin to see what can only be described as a beaten path...", (
                'f', 'b'),
            False),
        ...
        Map("Forest", (9, 8, 0, 4), "FOREST: (\S)",
            "The familiar smell of a wood fire floods your senses... (\S)Where could that be coming from...", (
                'f', 'r'),
            False),
        ...
        Map("Cabin Main Room", (0, 0, 0, 5), "CABIN MAIN ROOM: (\S)",
            "With a long creaking sound the door swings open... (\S)It is very apparent that this place is lived in. (\S)You wonder what else may lie within. To your left is the door back to the woods.", ('b', 'f'), False, 0, [("l", 8, 9, 0, 4)]),
        Map("Cabin Kitchen", (1, 0, 0, 5), "CABIN KITCHEN: (\S)",
            "Dishes fill the sink and meat hangs from the ceiling... Its fresh... (\S)This looks and smells like it is from the 50's.", ('r', 'b'), False),
        Map("Cabin Bedroom", (1, 1, 0, 5), "CABIN BEDROOM: (\S)",
            "A single bed is in the middle of the room. (\S)A dim lamp resides on a rickety bedside table. (\S)The wind blows gently through an open window as you notice a desk with some scattered notes upon it.", ('r', 'f'), False),
        Map("Cabin Bathroom", (0, 1, 0, 5), "CABIN BATHROOM: (\S)",
            "Nothing too out of the ordinary in here... (\S)The toilet is a bit old fashio- wait... (\S)Is the toilet paper actually bark? (\S)Clearly we ARE dealing with a madman. (\S)You look around the bathroom... Behind the door... under the sink...", ('l', 'f', 'b'), False)
    ]
    ...
    ITEMS1 = [
        Equipment("Cheese", (5, 7, 1, 0), "Cheese.jpg",
                  "Not just cheddar, the smelly kind.", "off-hand", (1, 1, 1), 5),
        Equipment("Delicious Meal", (None), "Meal.jpg",
                  "A beautiful, home-cooked, meal.", "off-hand", (1, 1, 1), 25),
        Equipment("Shovel", (5, 0, 0, 0), "Shovel.jpg",
                  "Call a spade a spade.", "hand", (15, 0, 5), ""),
        Equipment("Wrench", (1, 3, 1, 0), "Wrench.jpg",
                  "It's a wrench. 22mm.", "hand", (9, 0, 2), ""),
        Equipment("LED of Power", (None), "LED.jpg",
                  "An LED with the power output of a neutron star, ok maybe not.", "hand", (21, 0, 20), ""),
        Equipment("Green Bang Bong", (None), "GBB.jpg",
                  "The sacred glass flute providing righteous tokes since '69.", "off-hand", (69, 69, 69), ""),
        Equipment("Squid Hat", (3, 4, 3, 0), "SquidHat.jpg",
                  "The finest headwear you can aquire at Canada's Wonderland. Making you the fairest of all the arthropods.", "head", (4, 4, 7), ""),
        Equipment("COD WAW Case", (2, 4, 3, 0), "WAWCase.jpg",
                  "Call of Duty World at War for the PS3. The first game to introduce Zombies Mode. A fine game but definitely not school appropriate. You open the case and the disk isn't in it.", "off-hand", (1, 1, 1), ""),
        Equipment("Gas Mask", (3, 5, 1, 0), "GasMask.jpg",
                  "No one cared who I was till I put on the mask.", "head", (3, 6, 5), ""),
        Equipment("Surgical Mask", (0, 1, 1, 0), "SurgicalMask.jpg",
                  "Don't touch me I'm sterile!", "head", (0, 2, 3), ""),
        Equipment("Tofu", (5, 4, 0, 0), "Carrot.jpg",
                  "Vegan's delight.", "hand", (1, 0, 5), 2),
        Equipment("Jar of Horse Radish", (4, 5, 1, 0), "HRaddish.jpg",
                  "Apparently not an instrument...", "off-hand", (2, 0, 4), 3),
        Equipment("Squash Racket", (5, 0, 1, 0), "Racket.jpg",
                  "Dr. Buijs' Racket? Voltage Divider!", "hand", (5, 0, 8), ""),
        Equipment("Goggles", (3, 2, 1, 0), "Goggles.jpg",
                  "Got PPE?", "head", (2, 0, 2), ""),
        Equipment("Bike Helmet", (3, 7, 1, 0), "BikeHelmet.jpg",
                  "One of those fast Tour de France ones. Does this belong to Dr. Minnick? Great!", "head", (0, 8, 10), ""),
        Equipment("Empty Bottle", (4, 1, 1, 0), "EmptyBottle.jpg",
                  "Dasani, more like Dishonest! Amirite?!", "hand", (1, 0, 1), ""),
        Equipment("Hard Hat", (4, 2, 1, 0), "HardHat.jpg",
                  "You don't really want to look like a Civil kid. But at least it protects your head.", "head", (1, 10, 5), ""),
        Equipment("Priest Gown", (2, 0, 2, 0), "Gown.jpg",
                  "Wearing this gives people the impression you are a holy person...", "body", (10, 40, 10), ""),
        Equipment("Used Plunger", (5, 0, 0, 0), "Plunger.jpg",
                  "Used. Lovely...", "hand", (10, 0, 10), ""),
        Equipment("Dumbbell", (1, 0, 1, 0), "Dumbbell.jpg",
                  "The pump is the greatest feeling in the world.", "off-hand", (5, 0, 2), ""),
        Equipment("Febreze", (1, 0, 1, 0), "Ferbreze.jpg",
                  "Kills 99.9% of odour at the source!", "hand", (35, 0, 10), -4),
        Equipment("MSP430", (2, 3, 1, 0), "MSP430.jpg",
                  "A literal piece of garbage.", "hand", (-5, 0, -5), -5),
        Equipment("Declaration of Independence", (None), "DOI.jpg",
                  "I'm going to steal the Declaration of Independence...", "off-hand", (1, 1, 1), ""),
        Equipment("Needa Pita", (4, 6, 1, 0), "Pita.jpg",
                  "Better have gotten black olives on that", "hand", (2, 0, 1), 5),
        Equipment("Bottle Opener", (3, 7, 1, 0), "BottleOpener.jpg",
                  "I wish I had a bottle of wine right about now...", "off-hand", (0, 5, 15), ""),
        Equipment("Car Keys", (4, 2, 1, 0), "CarKeys.jpg",
                  "Volkswagen car keys with an 'R' on the keychain. Hmm...", "off-hand", (5, 0, 5), ""),
        Equipment("Erik's Frosted Tips", (None), "FrostedTips.jpg",
                  "Ever wanted to look rad as hell? Now you can!", "head", (0, 3, 20), ""),
        Equipment("Pedrotti Cubed", (None), "Pedrotti.jpg",
                  "'Property of Harold Haugen, one of the 3 Quantum Relics' is inscribed on the first page.", "off-hand", (50, 150, 250), ""),
        Equipment("Puke", (None), "Puke.jpg",
                  "Ew, literally a pool of vomit", "body", (1, 0, -10), -2),
        Equipment("Adderall", (5, 3, 1, 0), "Adderall.jpg",
                  "Speed up, my dude!", "off-hand", (0, 0, 50), 2),
        Equipment("Visor Glasses", (None), "FastGlasses.jpg",
                  "Damn, you are now travelling waaaay to fast. Slow down dude!", "head", (1, 5, 35), ""),
        Equipment("Plastic Bag", (2, 1, 1, 0), "PBag.jpg",
                  "The audacity of some people to leave their filth around.", "head", (0, 1, -10), ""),
        Equipment("Engineering Mug", (None), "EngMug.jpg",
                  "Do people even have these anymore?", "hand", (20, 20, 20), ""),
        Equipment("Broken Wine Bottle", (4, 3, 1, 0), "WineBottle.jpg",
                  "A broken wine bottle from 1996, good year.", "hand", (10, 0, 5), ""),
        Equipment("Jar of Peanut Butter", (4, 0, 1, 0), "Peanut.jpg",
                  "Death paste to those who are allergic... Could prove effective...", "off-hand", (0, 5, 5), 5),
        Equipment("Toilet Seat", (5, 0, 0, 0), "Toilet.jpg",
                  "How do you even wear this?", "body", (0, 3, 2), ""),
        Equipment("VH Sauce", (1, 4, 1, 0), "VHSauce.jpg",
                  "Sweet and sour. Nice.", "off-hand", (1, 2, 1), 1),
        Equipment("Banana", (1, 7, 1, 0), "Banana.jpg",
                  "High in potassium.", "hand", (5, 0, 5), 2),
        Equipment("Ice-Cold Pint", (4, 3, 1, 0), "Pint.jpg",
                  "Ale of the Gods.", "off-hand", (3, 0, -5), 2),
        Equipment("Pencil", (2, 4, 1, 0), "Pencil.jpg",
                  "HB2. Sharpened.", "hand", (2, 0, 5), ""),
        Equipment("Cricket", (3, 4, 2, 0), "Cricket.jpg",
                  "Makes the sound commonly heard at 2W lectures.", "off-hand", (1, 1, 1), 3),
        ...
        Equipment("Wood Shield", (5, 4, 2, 0), "Shield.jpg",
                  "An old wooden shield used in a play, you think...", "off-hand", (5, 20, -5), ""),
        Equipment("Cold Steel Katana", (None), "Katana.jpg",
                  "This could probably kill a buffalo fish...", "hand", (45, 5, 20), ""),
        Equipment("Flux Capacitor", (None), "FluxCapacitor.jpg",
                  "If only I could go back to 1985...", "hand", (1, 1, 1), ""),
        Equipment("Swordfish", (None), "Swordfish.jpg",
                  "I'd better be careful eating this!", "off-hand", (50, 10, 30), 20),
        Equipment("Ancient Incantation", (None), "Incantation.jpg",
                  "An old tattered scroll with an incantation written in Latin.", "off-hand", (1, 1, 1), ""),
        Equipment("Popeyes Chicken", (None), "Popeyeschicken.jpg",
                  "I love chicken, I love liver...", "off-hand", (5, 0, -5), 10),
        Equipment("Phone", (None), "Phone.jpg",
                  "This thing has been dropped Graham's number times.", "off-hand", (5, 6, 9), ""),
        Equipment("Casio", (2, 7, 1, 0), "Casio.jpg",
                  "This one can do integrals. That's illegal.", "off-hand", (1, 5, 10), ""),
        Equipment("Vomit", (None), "Vomit.jpg",
                  "Literally spew.", "off-hand", (0, 0, 1), -1),
        Equipment("Bleach Squirt Bottle", (None), "Bleach.jpg",
                  "Probably wouldn't be nice to get sprayed with.", "hand", (15, 5, 20), -10),
        Equipment("Drumstick", (5, 4, 2, 0), "Drumstick.jpg",
                  "'Property of E-Smooth'", "off-hand", (0, 10, 15), ""),
        Equipment("Self Worth", (None), "DOI.jpg",
                  "Wow, I had this in my all along! Now all I have to do is wait to go back to my bad habits and this will be worthless!", "off-hand", (20, 20, 20), -10),
        Equipment("Blazer", (5, 6, 1, 0), "Blazer.jpg",
                  "Styyyyyylishhhhhh", "body", (0, 4, 1), ""),
        Equipment("Empty Bucket", (5, 0, 0, 0), "Bucket.jpg",
                  "The smell of cheap soap still lingers.", "head", (0, 10, 1), ""),
        Equipment("Old Scroll", (None), "OldScroll.jpg",
                  "It reads: 'A permanent title is too much to bear.' 'My secret cache, is under there.'", "off-hand", (0, 0, 0), ""),
        Equipment("PID control system", (None), "PID.jpg",
                  "A PID control system. Kp = 69, my dude.", "head", (45, 69, 10), ""),
        Equipment("Voltage Divider", (None), "VDivider.jpg",
                  "It is a Voltage Divider!", "off-hand", (20, 25, 20), ""),
        Equipment("Frank's Red Hot", (0, 4, 1, 0), "FranksRed.jpg",
                  "I put that...", "off-hand", (3, 0, 2), 1),
        Equipment("Santa Hat", (0, 0, 1, 0), "SantaHat.jpg",
                  "Happy Holidays!", "head", (0, 3, 2), ""),
        Equipment("Banana Wires", (3, 4, 1, 0), "BanWires.jpg",
                  "Alligator clips added for extra whippage.", "hand", (8, 0, 8), 3),
        Equipment("Party Hat", (3, 6, 1, 0), "PartyHat.jpg",
                  "A nice hat from a cracker.", "head", (0, 5, 3), ""),
        Equipment("Jar of Mayo", (0, 2, 1, 0), "Mayo.jpg",
                  "Is mayonaise an instrument?", "off-hand", (3, 0, 5), 1),
        Equipment("Shampoo", (0, 0, 1, 0), "Shampoo.jpg",
                  "Yeah, I could use a shower...", "off-hand", (4, 0, 3), ""),
        Equipment("Candlestick", (4, 0, 0, 0), "Candlestick.jpg",
                  "Lumiere is up to no good.", "hand", (7, 0, 5), ""),
        Equipment("Gamma Glove", (None), "GammaGauntlet.jpg",
                  "Shorter than it really is due to length contraction, one of the 3 Quantum Relics", "hand", (250, 100, 20), ""),
        Equipment("Clean Needle", (None), "CleanNeedle.jpg",
                  "No more spreadin' disease!", "hand", (25, 0, 9), ""),
        Equipment("Laser Safety Glasses", (1, 6, 0, 0), "LSGlasses.jpg",
                  "Protection from the UV, my dude.", "head", (0, 10, 5), ""),
        Equipment("Tarzan VHS", (0, 2, 1, 0), "Tarzan.jpg",
                  "If only I had a VCR...", "off-hand", (0, 2, 6), 3),
        Equipment("Priceless Painting", (3, 0, 1, 0), "Painting.jpg",
                  "This painting is supposed to be worth millions...", "off-hand", (1, 10, 5), ""),
        Equipment("Paint Brush", (3, 1, 1, 0), "Brush.jpg",
                  "You can feel the emotions of a failed arts student coursing through this thing.", "off-hand", (5, 0, 5), ""),
        Equipment("Pizza Box", (0, 3, 1, 0), "PizzaBox.jpg",
                  "Fully equipped with crusted cheese.", "body", (1, 5, 1), 3),
        Equipment("Haugen's Clothes", (None), "HaugenShirt.jpg",
                  "OH My. The clothes of the gentle dolphin now gone. Feels kinda wet.", "body", (5, 10, 10), 10),
        Equipment("3W Textbook", (None), "3WText.jpg",
                  "Text book that probably has useful information if you could read it. Too bad it has never been in the QT", "off-hand", (5, 5, 10), ""),
        Equipment("Fireball Hat", (2, 2, 1, 0), "EngHat.jpg",
                  "Kind of like the hat you bought in first year and thought you'd wear forever...", "head", (0, 3, 1), ""),
        Equipment("Raybans", (5, 5, 1, 0), "Raybans.jpg",
                  "GQ Teen says Raybans, Board Shorts, Vans, and a Muscle Tee.", "head", (0, 1, 3), ""),
        Equipment("Gilded Blunderbuss", (None), "Blunderbuss.jpg",
                  "A beautiful firearm with infinite ammo.", "hand", (200, 5, 50), ""),
        Equipment("Einstein's Brain", (None), "Brain.jpg",
                  "Feel's kind of weird walking around with this...", "off-hand", (1, 1, 1), 10),
        Equipment("Tony Hawk Shirt", (3, 5, 1, 0), "TonyHAwkShirt.jpg",
                  "A shirt personally made by tony hawk!", "body", (5, 5, 5), ""),
        Equipment("Capstone Tools", (None), "CapTools.jpg",
                  "Shouldn't the 4A06 students be using these?", "off-hand", (1, 1, 1), ""),
        Equipment("Kenrick's Oscilloscope", (None), "Oscilloscope.jpg",
                  "The window into the electronics world...", "off-hand", (0, 150, 50), ""),
        Equipment("Femtosecond Laser", (None), "Laser.jpg",
                  "Haugen's personal femtosecond laser.", "hand", (125, 0, 999), ""),
        Equipment("Gauss Eye", (None), "GaussEye.jpg",
                  "You can feel the electromagnetic energy emanating from it, one of the 3 quantum relics", "head", (100, 100, 100), ""),
        Equipment("Okons Chainmail", (0, 2, 0, 0), "OkonMail.jpg",
                  "The sacred chainmail forged by the legend himself", "body", (25, 50, 25), ""),
        Equipment("Hazmat Suit", (2, 5, 1, 0), "Hazmat.jpg",
                  "Protection from all sorts of McCrindle farts...", "body", (0, 10, 5), ""),
        Equipment("Old Candle", (2, 0, 0, 0), "OldCandle.jpg",
                  "Seems like it's had some use.", "off-hand", (0, 2, 2), ""),
        Equipment("Tire Iron", (5, 7, 1, 0), "TireIron.jpg",
                  "Is this even a real tool? Or just a murder weapon...", "hand", (11, 0, 3), ""),
        Equipment("Ukelele", (4, 4, 1, 0), "Ukelele.jpg",
                  "Wasting away again in Margaritaville...", "hand", (6, 0, 5), ""),
        Equipment("Fanny Pack", (None), "FannyPack.jpg",
                  "Made for style. Not for carrying.", "body", (10, 60, 30), ""),
        Equipment("STARS Wireless Fix", (None), "StarsFix.jpg",
                  "IT took 6 weeks to make this code? Who knew debugging could be this hard?", "off-hand", (1, 1, 1), ""),
        Equipment("Brendan Fallon's Lunchbox", (3, 4, 0, 0), "Lunchbox.jpg",
                  "The Lunch Box of an Ancient Hero. Full of samosas.", "off-hand", (5, 10, 5), ""),
        ...
        Equipment("Ambifacient Lunar Waneshaft", (None), "Dumbness.jpg",
                  "The design consists simply of six hydrocoptic marzlevanes, they fit to the ambifacient lunar waneshaft so that side fumbling is effectively prevented", "off-hand", (1, 1, 1), ""),
        Equipment("Space Pop", (1, 7, 2, 0), "SpacePop.jgp",
                  "Get ready to go to space pop city.", "hand", (4, 0, 10), 1),
        Equipment("Hockey Pads", (5, 7, 1, 0), "HockeyPads.jpg",
                  "IM NOT WEARIN' HOCKEY PADS!", "body", (3, 13, 5), ""),
        Equipment("Starbucks Apron", (5, 0, 1, 0), "Apron.jpg",
                  "If you put this on do you immediately know how to make a frappe?", "body", (1, 5, 5), ""),
        Equipment("Pink Donut", (None), "PinkDonut.jpg",
                  "This is what fusion is all about?", "off-hand", (1, 1, 1), 2),
        Equipment("Relativistic Key", (None), "Relativistickey.jpg",
                  "You can feel the power radiating from this thing.", "hand", (1, 1, 1), ""),
        Equipment("Willy Dog", (4, 1, 1, 0), "Hotdog.jpg",
                  "Definitely not vegan", "hand", (1, 0, 2), 5),
        Equipment("Solar Ray", (None), "SolarRay.jpg",
                  "The literal power of the Sun!", "hand", (100, 20, 50), ""),
        Equipment("Helm of Orin Bearclaw", (1, 0, 3, 0), "SkullHelmet.jpg",
                  "A note left beside the helmet says 'A leftover relic from a purple hero'", "head", (35, 30, 10), ""),
        Equipment("Maroon Jumpsuit", (5, 1, 1, 0), "MaroonSuit.jpg",
                  "Overalls of the Maroons", "body", (1, 8, 5), ""),
        Equipment("Pope Hat", (2, 0, 2, 0), "PopeHat.jpg",
                  "Does the Pope where a silly hat? Now you do.", "head", (0, 3, 2), ""),
        Equipment("Lamp", (0, 5, 1, 0), "Lamp.jpg",
                  "I love lamp.", "hand", (8, 0, 4), ""),
        Equipment("Redsuit", (2, 4, 2, 0), "Redsuit.jpg",
                  "Overalls of drunks... I mean engineers", "body", (5, 5, 5), ""),
        Equipment("Butter Knife", (4, 6, 1, 0), "ButterKnife.jpg",
                  "Meant for spreading, not stabbing...", "hand", (4, 0, 5), ""),
        Equipment("Eng Phys Shirt", (3, 4, 0, 0), "EngPhysShirt.jpg",
                  "Rolling Rock baby! Premium Stream my ass... More like premium pain...", "body", (0, 7, 5), ""),
        Equipment("PVC Pipe", (4, 7, 1, 0), "PVCPipe.jpg",
                  "Probably part of a PID project...", "hand", (9, 2, 10), ""),
        Equipment("Big Hits Shirt", (6, 1, 1, 0), "BigHits.jpg",
                  "The Shirt of the Hero of Kyvach!", "body", (10, 5, 5), ""),
        Equipment("Couch Cushion", (1, 7, 1, 0), "CCushion.jpg",
                  "I hope I find I pillow fight.", "off-hand", (4, 10, 1), ""),
        Equipment("Crucifix", (None), "Crucifix.jpg",
                  "The Power of Chirst compels you!", "hand", (10, 0, 10), ""),
        Equipment("Joint of Destiny", (None), "Joint.jpg",
                  "A tighly rolled spliff filled with Devil's lettuce... for real.", "off-hand", (420, 420, 420), ""),
        Equipment("Minnick's Glasses", (None), "MinnickGlasses.jpg",
                  "The spectacles of a wizard from the High Order of the Ancient Council.", "head", (50, 50, 50), ""),
        Equipment("Mop", (0, 0, 1, 0), "Mop.jpg",
                  "I'm going to clean up this town.", "hand", (6, 0, 4), ""),
        Equipment("Cold Beer", (None), "ColdBeer.jpg",
                  "A freshly brewed pint from Andy Knights himself.", "off-hand", (15, 0, 20), 2),
        Equipment("Brian's Guitar", (None), "Guitar.jpg",
                  "You now have Brian's power to shred some sick tunes! ROCK ON.", "hand", (35, 35, 35), ""),
        Equipment("Old Headphones", (1, 5, 1, 0), "OldHeadphones.jpg",
                  "Old frayed apple headphones. Good for whipping.", "head", (5, 0, 5), ""),
        Equipment("Old Car Keys", (0, 6, 1, 0), "CarKeys.jpg",
                  "Fun for babies. Not for Batman.", "hand", (7, 0, 15), ""),
        Equipment("Coffee", (2, 4, 1, 0), "Coffee.jpg",
                  "The fuel of thinkers.", "off-hand", (3, 0, 9), 1),
        Equipment("Hulk Hands", (0, 3, 0, 0), "HulkHands.jpg",
                  "These pack a serious punch...", "hand", (15, 5, 20), ""),
        Equipment("Old Ladder", (0, 7, 1, 0), "OldLadder.jpg",
                  "Pretty rickety but would work for climbing.", "off-hand", (14, 8, -15), ""),
        Equipment("Goldfish", (2, 0, 2, 0), "Goldfish.jpg",
                  "Fun fact, not made of real gold.", "off-hand", (1, 1, 1), 4),
        Equipment("Horrible Assignment", (None), "BadAss.jpg",
                  "A barely legible report on Fourier analysis.", "off-hand", (3, 0, 0), ""),
        Equipment("Silicon Substrate", (0, 3, 2, 0), "Substrate.jpg",
                  "A bulk silicon wafer.", "off-hand", (1, 1, 1), ""),
        Equipment("Faraday's Cage", (None), "Faraday.jpg",
                  "Faraday cage.", "head", (20, 75, 15), ""),
        Equipment("Frisbee", (2, 2, 1, 0), "Frisbee.jpg",
                  "Look at the flick of the wrist!", "hand", (3, 0, 5), ""),
        Equipment("Rusty Key", (None), "RustyKey.jpg",
                  "You can just about read: 'By the building where the smallest are seen.' 'This key will provide for those who are keen'", "off-hand", (1, 1, 1), ""),
        Equipment("Iron Ring", (None), "IronRing.jpg",
                  "The One Ring to Rule them ALL.", "hand", (1000, 1000, 1000), -1000),
        Equipment("Pee Bottle", (2, 1, 1, 0), "PeeBottle.jpg",
                  "It is literally a bottle of urine.", "hand", (4, 0, 0), ""),
        Equipment("Bowling Ball", (None), "BowlingBall.jpg",
                  "Heavy.", "hand", (20, 15, -5), ""),
        Equipment("Wendy's Bag", (0, 6, 1, 0), "WendyBag.jpg",
                  "Fully equipped with grease stains.", "head", (1, 0, -5), ""),
        Equipment("High Vis Vest", (2, 6, 1, 0), "HighVis.jpg",
                  "Safety first, folks.", "body", (0, 5, 3), ""),
        Equipment("Phil's Braces", (2, 5, 0, 0), "PhilBraces.jpg",
                  "Bark AND the bite.", "head", (3, 2, 1), ""),
        Equipment("Potato", (None), "Potato.jpg",
                  "A most versatile vegetable. Good for breakfast, lunch, and dinner.", "off-hand", (1, 1, 1), 5),
        Equipment("Holy Bible", (2, 0, 1, 0), "Bible.jpg",
                  "King James version...", "off-hand", (3, 0, 3), ""),
        Equipment("Griffiths Electrodynamics", (2, 4, 2, 0), "Griffiths.jpg",
                  "The holy scriptures which govern the fabric of our being", "off-hand", (0, 10, 5), ""),
        Equipment("Skateboard", (0, 0, 0, 0), "Skateboard.jpg",
                  "Cowabunga, dude.", "hand", (9, 0, 10), ""),
        Equipment("Diary of the Fallen", (0, 2, 0, 0), "Diary.jpg",
                  "The personal notes of an ancient Hero.", "off-hand", (25, 20, 30), ""),
        Equipment("Green Lantern Shirt", (None), "GLShirt.jpg",
                  "Darkest day... Darkest night...", "body", (15, 15, 10), ""),
        Equipment("Dirty Needle", (0, 4, 1, 0), "Needle.jpg",
                  "This isn't clean. Someone find me a SharpXchange!", "hand", (7, 0, 5), ""),
        Equipment("Stylish Watch", (None), "watch.jpg",
                  "If only you learned how to tell time on an analog clock...", "off-hand", (0, 15, 20), ""),
        Equipment("Huge Shirt", (None), "HugeShirt.jpg",
                  "This shirt is WAY too big", "body", (0, 5, 5), ""),
        Equipment("Fake Gun", (None), "FakeGun.jpg",
                  "Is this seriously what at the MAC cops carry...", "hand", (5, 0, 5), ""),
        Equipment("Wool Sweater", (5, 3, 1, 0), "WoolSweater.jpg",
                  "Merino Wool. Just like grandma makes.", "body", (1, 4, 6), ""),
        Equipment("Solar Cell", (None), "SolarCell.jpg",
                  "Harness the power of the Sun! I really hope I don't drop this...", "off-hand", (1, 1, 1), ""),
        Equipment("Paper Towels", (0, 5, 2, 0), "PaperTowels.jpg",
                  "WHERE'S THE PAPER TOWELS?", "off-hand", (2, 0, 1), ""),
        Equipment("Crocs of the Cartographer", (None), "DadCrocks.jpg",
                  "Grass stains on it from where you dad would cut the lawn every Sunday. Blue jeans, no shirt. (\S)f I think he used to be an alumni here?", "body", (4, 20, 69), ""),
        ...
        Equipment("Tyler's Visor Glasses", (None), "FastGlasses.jpg",
                  "Damn, you are now travelling waaaay to fast. Slow down dude!", "head", (1, 5, 35), ""),
        Equipment("Tyler's Big Hits Shirt", (None), "BigHits.jpg",
                  "The Shirt of the Hero of Kyvach!", "body", (10, 5, 5), ""),
        Equipment("Tyler's Hulk Hands", (None), "HulkHands.jpg",
                  "These pack a serious punch...", "hand", (15, 5, 20), ""),
        Equipment("Tyler's Green Bang Bong", (None), "GBB.jpg",
                  "The sacred glass flute providing righteous tokes since '69.", "off-hand", (69, 69, 69), ""),
        Equipment("LON-CAPA Code", (5, 3, 0, 0), "LONCAPA.jpg",
                  "This sacred Python code has saved many an engineering a tight pinch. Or just too lazy to do their own work. I wonder who made it?", "off-hand", (1, 1, 1), ""),
        Equipment("Student Card", (5, 1, 1, 0), "SCard.jpg",
                  "Someone just dropped their student card here? The owner is Lemieux M., I guess he doesn't need it anymore.", "off-hand", (1, 1, 1), ""),
        Equipment("Rubber Chicken", (None), "RChicken.jpg",
                  "Rub a dub dub in my tub.", "off-hand", (3, 3, 3), 3),
        ...
        # --- Aesthetic Objects ---
        Equipment("Kipling Pranks", (2, 3, 1, 0), "KPranks.jpg",
                  "The leftover pranks from the 2017-2018 year. You should probably leave these here.", "off-hand", (2, 2, 2), 3),
        Equipment("Tequila Shot Glass", (5, 4, 1, 0), "ShotGlass.jpg",
                  "Maybe you shouldn't touch this stuff after what happened last night.", "off-hand", (10, 0, 10), -5),
        Equipment("Cold Sweat", (3, 4, 1, 0), "ColdSweat.jpg",
                  "A pool of sweat on the ground. Gross.", "off-hand", (0, 0, 0), 1),
        Equipment("Polaroid Photograph", (None), "PolaroidPhoto.jpg", "What? Do people still make these? Next thing you know you'll find an 8-inch floppy disk laying around. (\S)The photo shows you smashed out of your mind at the " + \
                  mapcolour + "Phoenix" + textcolour + ". Looks like a good time.", "off-hand", (0, 0, 0), -2),
        Equipment("Flashcard", (None), "Flashcard.jpg",
                  "The cards are full of notes for studying some crazy biology. Watch out for paper cuts.", "off-hand", (3, 0, 0), 1),

        # --- Haunted Forest Items ---
        Equipment("Golden Apple", (1, 0, 0, 5), "GApple.jpg",
                  "This luxurious apple glowes in the light. A rare commodity as eating it restores full health.", "off-hand", (1, 1, 1), 1000),
        Equipment("Staff of the Indomitable", (0, 6, 0, 4), "TStaff.jpg",
                  "A trusted protector of the forest donned with leaves of brilliant colour.", "hand", (150, 75, 125), ""),
        Equipment("Staff of the Unwavering", (0, 6, 0, 4), "BStaff.jpg",
                  "A loyal trail guardian once owned by the descendant of a grand wizard.", "hand", (75, 175, 125), ""),

        Equipment("1 Stick", (3, 0, 0, 4), "Stick.jpg",
                  "It is a stick found in the forest.", "hand", (5, 5, 5), -1),
        Equipment("2 Sticks", (9, 1, 0, 4), "Stick.jpg",
                  "2 sticks bundled together.", "hand", (10, 10, 10), -1),
        Equipment("3 Sticks", (0, 3, 0, 4), "Stick.jpg",
                  "3 sticks bundled together.", "hand", (12, 12, 12), -1),
        Equipment("4 Sticks", (1, 5, 0, 4), "Stick.jpg",
                  "4 sticks bundled together.", "hand", (14, 14, 14), -1),
        Equipment("5 Sticks", (5, 6, 0, 4), "Stick.jpg",
                  "5 sticks bundled together.", "hand", (15, 15, 15), -1),

        Equipment("Fireplace Tongs", (5, 6, 0, 4), "Tongs.jpg",
                  "This looks useful for grabbing things out of a fire.", "hand", (15, 15, 15), ""),

        Equipment("Trail Mix", None, "TrailMix.jpg",
                  "A lot of calories in this!", "off-hand", (1, 1, 1), 8),
        Equipment("Pointy Stick", (5, 4, 0, 4), "Stick.jpg",
                  "It is a pointy stick found in the forest.", "hand", (20, 20, 20), -5),
        Equipment("Old Mitten", (2, 3, 0, 4), "OldGlove.jpg",
                  "It is an old mitten who appears to have lost its mate.", "off-hand", (2, 6, 3), ""),
        Equipment("Heavy Rock", (3, 4, 0, 4), "HeavyRock.jpg",
                  "This rock is really cool looking but a lot of work to carry around.", "hand", (5, 5, 5), -1),
        Equipment("Small Rock", (7, 5, 0, 4), "SmallRock.jpg",
                  "A small rock about the size of a plum.", "hand", (4, 2, 7), -25),
        ...
        Equipment("Broken Bone", (9, 7, 0, 4), "BrokenBone.jpg",
                  "The broken bone of an animal. You can tell the marrow has been sucked out.", "hand", (
                      12, 1, 8),
                  -10),
        ...
        Equipment("Soda Pop Rings", (3, 9, 0, 4), "SodaRings.jpg",
                  ...
                  "off-hand", (1, 1, 1), -10),
        Equipment("Wolf Meat", None, "Wolfmeat.jpg",
                  "This looks remotely edible...", "off-hand", (1, 1, 1), 5),
        Equipment("Small Squirrel Meat", None, "SSMeat.jpg",
                  "This looks barely edible...", "off-hand", (1, 1, 1), 5),
        Equipment("Big Squirrel Meat", None, "BSMeat.jpg",
                  "This looks kind of edible...", "off-hand", (1, 1, 1), 5),
        ...
        # -- Quest Items --
        Equipment("Furnace Door", None, "FDoor.jpg",
                  "A sturdy cast-iron door. (\S)Better get three coffins ready...", "body", (10, 100, 5), ""),
        Equipment("Jar of Olives", None, "JoOlives.jpg",
                  "Kalamata's? No way!", "off-hand", (1, 1, 1), 8),
        Equipment("Old Pickaxe", None, "OldPickaxe.jpg",
                  "An old pickaxe.", "hand", (12, 8, 5), ""),
        ...
        Equipment("Charcoal", None, "Charcoal.jpg",
                  "A dusty lump of charcoal.", "off-hand", (1, 1, 1), -10),
        ...
        Equipment("Ring Pop", None, "Ringpop.jpg",
                  "A small sugary treat", "off-hand", (1, 1, 1), 5),
        Equipment("Matches", None, "Matches.jpg",
                  "Perhaps I should preparea firepit for these.", "off-hand", (1, 1, 1), -10),
        Equipment("Gunpowder", None, "Gunpowder.jpg",
                  "You should look for a canister of some sort to put this in.", "off-hand", (1, 1, 1), -10),
        Equipment("Small Key", None, "Smallkey.jpg",
                  "A small metallic key found within a cookie jar in the Cabin in the woods.", "off-hand", (1, 1, 1), -1)
    ...
    ENEMIES1 = [
        ...
        Enemy("Dan Fitzgreen", "Hello, although I've turned to the dark side to do Physics Labs\n I'm still a great guy. Did I mention I worked at CERN!?", (None), (100, 75, 100), 400, "ambifacient lunar waneshaft", "",
              "'Been a lot stirring around the faculty since last night.'\n'I used to be an adventurous student like you before the High Council and I decided to part ways.'\n'I know what you seek and I am here to help.'\n'You need to fire up that old reactor in the basement of the Tandem Accelerator.'\n'It needs some sort of high power instrument to bring it to life...'\n'I think Dr. Nagasaki has been working on something like that, he is probably somewhere in ITB.'\n'He will likely need this...'", "I'm moving to the physics department", False),
        Enemy("Kenrick", "'The oscilloscope is the window into the electronic world.'", (3, 3, 1, 0), (100, 100, 200),
              75, "Kenrick's oscilloscope", None, "", "Oh no! My window! The Dark Lord will know I've failed him!", False),
        Enemy("Dr. Soleymani", "'Are you interested in a research position?'", (0, 1, 2, 0), (30, 30,
                                                                                              30), 50, "Einstein's Brain", None, "", "NOOO! The Dark Lord will never forgive me!", False),
        Enemy("Sir William McMaster", "'You must rid the university of the evil Dr. Cassidy has planned!'", (None), (175, 125, 100), 125, "iron ring", "", "",
              "The spirit of Sir William McMaster bursts with a fiercely bright explosion.\nYou look down to see your Iron Ring as well as the deed to McMaster!\nDr. Cassidy quickly picks up the deed and turns to you.\n'Excellent!' he says coupled with maniacal laughter.\n'Too fulfill your true destiny, take the power you hold in your Iron Ring and destroy all of the rest of the Quantum Order!'\n'Only after they are gone can Engineering Physics truly reign supreme!'", False),
        Enemy("Chris", "'The tools should be coming any day now.'", (4, 5, 1, 0), (50,
                                                                                   75, 50), 50, "capstone tools", None, "", "I was going to quit anyway!", False),
        # Special
        Enemy("Brendan Fallon", "What's up dude? I'm here to bless up your shit.\nDo you have my lunch box?", None,
              (9999, 9999, 9999), 999, "green bang bong", "Brendan Fallon's lunchbox", "THANKS! TOKE UP MY DUDES!", "", False),
        Enemy("Hooded Man", "I've been looking for you. Especially after what you did last night.\nI recommend you seek out the profs if you are to find your ring...\nOnly they can right the wrongs you have done.",
              (5, 4, 1, 0), (999, 999, 999), 999, "iron ring", None, "", "NO!!! HOW DID YOU KNOW IT WAS ME?", False),
        Enemy("yourself", "Wait, but I'm you? Sorry I'm a little busy to think about this right now.", None, (100, 100,
                                                                                                              100), 100, "self worth", None, "", "Congratulations, you've conquered yourself! It wasn't that hard!", False),
        Enemy("your dad", "Tell your mom the mower's fixed. I'm going to wash the lawn.", None, (250, 250, 250), 200,
              "crocs of the cartographer", None, "Let's rock & roll!", "At least I don't have to pay the mortgage!", True),
        Enemy("Alex Jones", "YOU THINK YOU'RE A TOUGH GUY. YOU'RE AN INTELLECTUAL DUMBASS", None, (300, 300, 300), 200, " ",
              None, "WE'RE GUNNA DEFEAT THIS ANTI-HUMAN SCUM. WE'RE GUNNA ROCK THEIR WORLD@", "I HATE YOU. COWARDDD!!!!", True),
        ...
        # General
        Enemy("Liam the Gamer", "I am NOT going to finish this assignment... if only I had one to copy.", (3, 4, 0, 0), (10, 10,
                                                                                                                         10), 15, "Swordfish", "horrible assignment", "Nice! Take this swordfish. I needed 45 cooking for that.", "", False),
        Enemy("Connor the Biologist", "I would really like a cricket to continue my research...", (1, 7, 3, 0), (10, 10, 10), 15,
              "PID control system", "cricket", "Thanks! I don't know what this does but you can have it!", "'I can't believe you've done this.", False),
        Enemy("Father Frobenius", "'You need prayer. Recharge at the altar.'",
              (2, 0, 1, 0), (10, 10, 10), 25, "crucifix", None, "", "I am slain!", True),
        Enemy("Steven the first-year", "'Have you got the LON-CAPA Python code?'", (3, 6, 1, 0), (5, 1, 10), 15, "engineering mug",
              "LON-CAPA Code", "Thanks man! Now I can get a 12 in at least 6 math courses.", "I'm a failure at home and at school!", False),
        Enemy("Phil the drunk", "'MHhmgh, Soouh whatu we getta druuuunk'", (5, 5, 1, 0), (10, 5, 1), 15, "coffee", "phil's braces",
              "'UHhhh i thinka im gonna- im gon-' Phil vomits. Thanks man, I'll buy you a coffee. I gotta go rock climbing!", "mhmh spooky ghost urggh ectoplasm noooooo", False),
        Enemy("Jana the vegan", "'Did I mention I'm vegan?'", (5, 4, 0, 0), (15, 1, 5),
              10, "3w textbook", None, "", "I was going to bring it back I swear!", False),
        Enemy("Larry the bus driver", "'Is that even your bus pass?'", (2, 1, 1, 0), (10, 10,
                                                                                      5), 40, "huge shirt", None, "", "That was definitely not your bus pass!", True),
        Enemy("Rod the bowler", "'Righteous! Could you help me get into my car?\nI lost my keys and can't find my car.\nI REALLY need what is in there.'", (5, 7, 1, 0),
              (14, 20, 5), 40, "delicious meal", "bowling ball", "Thanks!\nNow I can learn to bowl that perfect strike.\nTake this, I just cooked it up.", "Ouch!", False),
        Enemy("Brian the Weeb", "'HAHA, you were a RIOT at the Phoenix last night! (\S)Also I'm really hungry, can you bring me a potato'",
              (2, 2, 1, 0), (5, 2, 10), 10, "brian's guitar", "potato", "THANKS MAN! I was super hungry.", "That's not vegan.", False),
        Enemy("Mitch the TA", "'Hey, I saw your picture on Instagram!'\n'They let you get away with doing that to the Willy McMaster statue?'",
              (0, 3, 1, 0), (10, 5, 10), 25, "phone", None, "", "There's my phone.", True),
        Enemy("Erik the Sk8r", "'Check out this tre flip, pretty tight eh? Also have you seen my drumstick?'", (0, 0, 0, 0), (15,
                                                                                                                              15, 40), 20, "Erik's frosted tips", 'drumstick', "Aww thanks man! Here, you can have this!", "Man, that's dumb!", False),
        Enemy("Megan the Bartender", "'Wait... I recognize you... you have a $420E69 tab!'",
              (5, 4, 1, 0), (15, 20, 10), 20, "popeyes chicken", None, "", "Nuuuuuuuuuuuu", False),
        Enemy("Bill the MAC Cop", "'Give me your student card!'", (3, 5, 1, 0), (50, 25, 10),
              50, "solar cell", 'student card', "", "We aren't able to arrest you anyway!", False),
        Enemy("Stefan Boltzmann", "Taste my lightning!", (None), (95, 50, 75), 75, "pink donut", None, "",
        ...
        Enemy("Zack the Snack", "'I need a snack that smiles back!'", (2, 4, 0, 0), (17, 12, 15), 25, "fanny pack",
              "goldfish", "Whoa thats whack! Check out this fanny pack.", "Why are you the way you are?", False),
        Enemy("Will the MAC Cop", "'Give me your student card!'", (4, 2, 1, 0), (50, 25,
                                                                                 10), 50, "fake gun", None, "", "We aren't able to arrest you anyway!", True),
        Enemy("Andreas the Nerd", "'I heard some jebroni took the 3W Textbook and hid in Bridges cafe.'\n'Full send, dude!'",
              (3, 2, 1, 0), (10, 15, 5), 50, "visor glasses", None, "", "Dude, that was definitely a full send", True),
        Enemy("Eric the Baller", "'Huge talking to people play.'", (0, 5, 0, 0),
              (20, 15, 20), 50, "Cold Steel Katana", None, "", "This is sub-optimal.", True),
        Enemy("Mario the Mixologist", "'Yo check out my meme page, you ever heard coco jay?'", (1, 4, 1, 0),
              (15, 10, 20), 50, "stylish watch", None, "", "si ya saben como consigo, por que me invitan?", True),
        Enemy("Paul the Janitor", "'Hey brother, I really could use some Febreze.'", (0, 5, 1, 0), (20, 20, 20), 20,
              "bleach squirt bottle", "Febreze", "Rock on brother! Thanks so much!", "NOOO, Now I can't go see Black Sabbath!", False),
        Enemy("Undead Grad Student", "'Mussst eeaaat funnnndingg... Er, I mean braaains.'", (2, 0, 0, 0), (20, 10, 1),
              20, "horrible assignment", "einstein's brain", "", "My 12 year post-grad was for nothiiiiiingggggg!", False),
        Enemy("Daniel Parent", "Hi I'm amazing and Daniel", (3, 4, 1, 0), (30,
                                                                           30, 40), 50, "STARS Wireless Fix", None, "Thanks!", "FINALLY!", True),
        Animal("Fred the Good Boy", "You talk to Fred. His wise eyes stare at you. It's almost as if he understands what you're saying but he'd rather have have you play with the ball.", (0, 0, 0, 3), (10000000, 10000000, 10000000), 10000000,
        ...
        Enemy("Nicole the Assistant", "Hi! Welcome to the Engineering Physics Office. What can I help you with? Dr. Lapierre should be just across the tunnel in ABB if you're looking for him.",
              (1, 5, 2, 0), (15, 30, 15), 40, None, None, "", "NO! Did I send you too many emails?", True),
        Animal("Liam the Library Dog", "You talk to Liam and it seems to help. Maybe this therapy stuff does work.", (4, 0, 1, 0), (10000000,
                                                                                                                                    10000000, 10000000), 10000000, None, None, "", "", "Liam cuddles beside you while you scratch/pet him. He's really good at his job.", True),
        Enemy("Devan the most Unhelpful", "You ask Devan if he knows anything about your " + itemcolour + "iron ring" + textcolour + ". (\S)He says: 'How'd you hear about this? What did the " + indicatecolour + "quantum order" + \
              textcolour + " tell you? We can't speak here, come meet me in " + mapcolour + "JHE Basement" + textcolour + ".'", (1, 3, 1, 0), (25, 25, 25), 50, None, None, "", "I WASNT'T GOING TO GIVE YOU A GOOD MARK ANYWAYS!", False),
        Enemy("Hannah the Helpful", "Hey are you okay after what happened at the " + mapcolour + "Phoenix" + textcolour + \
              "? Do you need help?", (1, 4, 2, 0), (25, 25, 25), 50, None, None, "", "No! How am I going to make a great capstone now!", True),
        Enemy("Matt the Vuk", "Man you're crazy haha. I wouldn't be walking after what you did at the " + mapcolour + "Phoenix" + \
              textcolour + ".", (4, 4, 1, 0), (25, 25, 25), 50, None, None, "", "Now how am I supposed to be the ultimate Eng Phys guy?", True),
        Enemy("Arthur the D'art", "Even though I'm in seven courses right now I'd love to talk!",
              (5, 3, 1, 0), (25, 25, 25), 50, None, None, "", "At least it's better than Eng Phys!", True),
        Enemy("Angus the Barber", "He's dressed in a pirate costume and saying: 'Four FOURS!'", (0,
                                                                                                 7, 1, 0), (25, 25, 25), 50, None, None, "", "You'll spend an eternity on this ship!", True),
        Enemy("Neil the Man", "Neil is quietly studying with his headphones on. Best not to disturb him.",
              (3, 4, 0, 0), (50, 50, 50), 75, None, None, "", "Well this is better than 2P with Phil!", True),
        Enemy("Keara the Mera", "Hey! Aren't you the guy that ruined the " + mapcolour + "McMaster statue" + \
              textcolour + " last night?", (5, 0, 1, 0), (25, 25, 25), 50, None, None, "", "Why would you do that!?", True),
        Enemy("Dawson the Tie Dye Guy", "Sa dude! These psychedelics rock!",
              (0, 4, 1, 0), (25, 25, 25), 50, None, None, "", "Dudeee, why?", True),
        Enemy("Danya the Daniel", "Don't bug me I'm studying. No quests please. I would love something vegan to eat though.", (1, 1,
                                                                                                                               1, 0), (25, 25, 25), 50, "flashcard", "tofu", "Oh thanks! I'll need this later!", "Veganism is the moral baseline!", False),
        Animal("Rory the Cat", "You observe this black cat in a red bowtie. Talking to him provides a stimulating conversation. Looks like he wants that chicken in your pocket.", (5, 4, 1, 0), (10000000, 10000000, 10000000), 10000000,
               None, None, "The black cat takes the chicken into its mouth and bolts off. You swear you see him jump into another dimension.", "", "Rory takes a few skritches but then playfully scratches you back, ouch!", False),
        ...
        Enemy("Shady Guy", "'Hey, you got any suckers?' (\S)'Something sweet maybe?'", (1, 4, 0, 4), (25, 15, 20), 40, "matches", "ring pop",
              "'Hey thanks!' (\S)'Maybe you can use this to make a fire while you're out here in these creepy woods...'", "'Why would you kill me! I did not want to be killed!'", False),
        Animal("Wolf", "You talk at the wolf but it just stares at you blankly.", (9, 3, 0, 4), (15, 15, 50), 20, "Wolf Meat",
               None, None, "ARRRROOOOOOOOOO!", "You would pet the wolf but it's kinda scary. It might bite you!", True),
        Animal("Small Squirrel", "You talk at the small squirel but it doesn't respond. Are you going insane?", (7, 4, 0, 4), (5, 5, 30), 10, "small squirrel meat", None,
               None, "It didn't put up much of a fight.", "You put your hand out and the squirrel climbs up your hand! You play with it for a bit before carying on", True),
        Animal("Big Squirrel", "You yell at it 'YOU'D MAKE A TASTY MEAL'. It doesn't seem to mind.", (4, 7, 0, 4), (5, 20, 30), 10, "big squirrel meat", None, None,
               "Thicc boi didn't put up much of a fight...", "You put your hand out and the squirrel climbs up your hand! You play with it for a bit before carying on", True),
        Enemy("Elderly Man", "'Oh hi there young one!'(\S)'My eyes aren't like they used be...' (\S)'My life spent in the mines may have taken its toll.' (\S)'I have this note here that I would love to be able to read if only I had my glasses...'", (8, 0, 0, 4), (20, 10, 5), 45, "old pickaxe",
              "aged glasses", "'Oh thank you!' (\S)'Let me read this note I have here...' (\S)'Equal parts sulfur and charcoal makes a good boom with some high heat.' (\S)'Hmmm whatever that means... Here take this old pick! (\S)'I dont have any use for it.'", "'Nooooo! Why would you kill an old man??'", False),
    ]
    ...
    INTERACT1 = [
        ...
        Interact("Garbage Can", (2, 3, 1, 0), "It's a garbage can.",
                 "You throw the MSP430 in... Yes, you have chosen wisely.", "msp430", "Vomit", False),
        ...
        Interact("Blue Book", (4, 0, 1, 0),
                 "It's a biology textbook. (\S)Flipping through you read: (\S)'The mitochondria is the powerhouse of the cell.'", "", "", "", True),
        ...
        Interact("McMaster Map", (1, 2, 1, 0),
                 ...
                 "Through Minnick's glasses the true map is revealled!(\S)You read:'Harness the sun.'(\S) ________________________________________________(\S)|Map of McMaster                                 |(\S)|                                       BATES    |(\S)|                                                |(\S)| ETB        JHE         BSB                     |(\S)|                                                |(\S)|                        \/            STATUE    |(\S)|                        /\                      |(\S)| HOSPITAL                                       |(\S)|          MDCL         CHAPEL              MUSC |(\S)|________________________________________________|(\S) (\S)Dr. Minnick's glasses glow hot as you quickly swat them off of your face.", "Minnick's glasses", "Minnick's glasses", False),
        Interact("Workbench", (1, 7, 0, 0),
                 "Looks like an old dusty workbench.", "", None, "", True),
        Interact("Lenovo Laptop", (2, 4, 1, 0), "This heap of computing majesty could block bullets... I think...",
        ...
        Interact("Lake Painting", (3, 0, 1, 0), "A painting of a beautiful lake. It brings you peace.",
        ...
        # --- Aesthetic Interacts ---
        Interact("Iron Ring Statue", (2, 3, 1, 0),
                 "The beautiful statue shines in the light. 'From the Class of 2017'. It reminds you of your lost ring, which you remember you should go find.", "", None, "", True),
        Interact("Morning Sun", (2, 3, 1, 0), CLEARSCREEN + \
                 "You stare at the sun for an hour. You're practically blind now and can't remember what you were doing before.", "", None, "", True),
        Interact("Kipling Game", (2, 4, 1, 0),
                 "It's a laser pointer arcade game. Wow this is fun. And it counts your score! How did they have time to make this?", "", None, "", True),
        Interact("Kipling Clock", (1, 4, 1, 0),
                 "Days to Kipling: 364 until that next fateful day. Hopefully there's no one in your situation next year.", "", None, "", True),
        Interact("Armchair", (1, 1, 1, 0),
                 "It looks comfortable at first but it's really not. Do they really expect you to do work in these things?", "", None, "", True),
        Interact("Organ", (2, 0, 1, 0),
                 "A hammond B3 Organ. A fine specimen.", "", None, "", True),
        Interact("Dirty Coffee Table", (3, 1, 1, 0),
                 "A very boujee coffee table display art piece. You don't want to tell the art students how you really feel about this.", "", None, "", True),
        Interact("Willy dog cart", (4, 1, 1, 0),
                 "The man in the cart eyes you warily as you ask for your 5th hotdog of the day. You hand him a fiver and walk away.", "", None, "", True),
        Interact("McMaster Statue", (5, 2, 1, 0),
                 "There are marks of defilement all over the statue. You wonder if this has anything to do with the happenings of last night?", "", None, "", True),
        Interact("Canadian Flag", (3, 2, 1, 0),
                 "This majestic flag waves gracefully in the wind. Canada and proud. ", "", None, "", True),
        Interact("Slackline", (2, 2, 1, 0),
                 "You attempt to walk across this but you don't have the coordination or skill. Practice makes perfect.", "", None, "", True),
        Interact("Reactor Pool", (2, 6, 1, 0),
                 "The blue pool of the McMaster Nuclear Reactor (MNR). Swimming is not advised.", "", None, "", True),
        Interact("No Access Sign", (4, 3, 1, 0),
                 "You read the sign which definitely says 'no vehicle access' and wonder how it could ever be misinterpreted...", "", None, "", True),
        Interact("Water Fountain", (0, 1, 1, 0),
                 "You take a big gulp of Hamilton's finest filtered dihydrogen monoxide... yum", "", None, "", True),
        ...
        Interact("Opening in the Trees", None, "With your knowledge you can now travel through the forest.",
                 "You push your way through the brush and after a while you lose track of where you entered from...", None, None, False),
        Interact("Trail to Cootes Drive", (4, 0, 0, 4), "What was that place?",
                 "You push your way through the brush and after a while you make it to Cootes Drive...", None, None, False),
        ...
        Interact("Empty Soda Can", (3, 9, 0, 4), "It is an empty soda can... what could you possibly do with that?",
                 "You fill the can with gunpowder. (\S)This would surely make a boom if you could get it hot enough...", "gunpowder", "makeshift explosive", False),
